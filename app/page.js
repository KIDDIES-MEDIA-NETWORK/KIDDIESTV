      ...
      <div className="">
        ...
        <div className="relative">
          ...
          <video
            ...
            muted
            alt="video card1"
            className="static md:absolute mt-10  md:mt-0 md:top-44 lg:top-[32vh] xl:top-[32vh] 2xl:top-40 flex flex-col justify-center items-center md:right-[50%] text-center md:translate-x-[50%] brightness-[0.3] float-none m-auto md:rounded-3xl object-cover w-full md:w-[69%] md:h-[68vh]"
