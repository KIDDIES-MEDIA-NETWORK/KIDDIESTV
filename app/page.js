      ...
      <div className="">
        ...
        <div className="">
          ...
          <video
            ...
            muted
            alt="video card1"
            className="static md:absolute mt-10 top-0  md:mt-0 md:top-36 lg:top-36 xl:top-40 2xl:top-40 flex flex-col justify-center items-center md:right-[50%] text-center md:translate-x-[50%] brightness-[0.3] float-none m-auto md:rounded-3xl object-cover w-full md:w-[70%] md:h-[32rem]"
            height={300}
            width={300}
          />
